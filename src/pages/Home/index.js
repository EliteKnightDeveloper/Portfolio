...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const typed = new Typed(el.current, {
      strings: ['Full Stack Engineer', 'Open Sourcer'],
      shuffle: false,
      startDelay: 500,
      typeSpeed: 60,
      backSpeed: 50,
  ...
  useEffect(() => {
    ...
    window.addEventListener('mousemove', function (e) {
      var lMouseX = Math.max(
        -100,
        Math.min(100, windowSize.innerWidth / 2 - e.clientX)
      );
      var lMouseY = Math.max(
        -100,
        Math.min(100, windowSize.innerHeight / 2 - e.clientY)
      );
  ...
  const descLine2List = 'Nguyen Hieu,'.split(' ');
  ...
  return (
    <>
      <Helmet>
        ...
        {/* Meta Info */}
        <meta name="title" content="Nguyen Hieu" />
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Nguyen Hieu" />
        <meta
        ...
        <meta name="twitter:title" content="Nguyen Hieu" />
        <meta
      ...
      <HeroWrapper>
        ...
        <MainAreaWrapper>
          <IntroWrapper>
            ...
            {!mobile ? (
              <a.h2 style={descLine4Anim}>
                I make immersive software that moves
                <br />
                people.
              </a.h2>
            ) : (
              <a.h2 style={descLine4Anim}>
                I make immersive software
                <br />
                that moves people.
              </a.h2>
            )}
          ...
          <WorkAndEmailWrapper style={wtReveal}>
            <WorkLink to="/works">
              {worksTitleReveal.map(({ ...style }, index) => (
                <a.span style={style} key={index}>
            ...
            <TriangleDiv>
              <a href="mailto:trungquann411@gmail.com">
                trungquann411@gmail.com
              </a>
            </TriangleDiv>
          </WorkAndEmailWrapper>
        </MainAreaWrapper>
        <FooterWrapper>
          {!mobile ? (
            <SocialIcons style={socialIconsAnim} />
          ) : (
            <SocialIcons
              style={socialIconsAnim}
